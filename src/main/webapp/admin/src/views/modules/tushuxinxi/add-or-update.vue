<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="isbn" prop="isbn">
          <el-input v-model="ruleForm.isbn" 
              placeholder="isbn" clearable  :readonly="ro.isbn"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="isbn" prop="isbn">
              <el-input v-model="ruleForm.isbn" 
                placeholder="isbn" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tushufengmian" label="图书封面" prop="tushufengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tushufengmian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实体价格" prop="shitijiage">
          <el-input v-model="ruleForm.shitijiage" 
              placeholder="实体价格" clearable  :readonly="ro.shitijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实体价格" prop="shitijiage">
              <el-input v-model="ruleForm.shitijiage" 
                placeholder="实体价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电子版价格" prop="dianzibanjiage">
          <el-input v-model="ruleForm.dianzibanjiage" 
              placeholder="电子版价格" clearable  :readonly="ro.dianzibanjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电子版价格" prop="dianzibanjiage">
              <el-input v-model="ruleForm.dianzibanjiage" 
                placeholder="电子版价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="图书概要" prop="tushugaiyao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tushugaiyao" label="图书概要" prop="tushugaiyao">
                    <span v-html="ruleForm.tushugaiyao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	dianzibanjiage : false,
      ...
      rules: {
          ...
          shitijiage: [
                { required: true, message: '实体价格不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          dianzibanjiage: [
                { required: true, message: '电子版价格不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
      }
    };
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushugaiyao = true;
          ...
          if(o=='shitijiage'){
            this.ruleForm.shitijiage = obj[o];
	    this.ro.shitijiage = true;
            continue;
          }
          if(o=='dianzibanjiage'){
            this.ruleForm.dianzibanjiage = obj[o];
	    this.ro.dianzibanjiage = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.tushugaiyao = this.ruleForm.tushugaiyao.replace(reg,'../../../ssm6p3nm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

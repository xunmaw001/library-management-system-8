<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="购买类型" prop="goumaileixing">
          <el-select v-model="ruleForm.goumaileixing" placeholder="请选择购买类型">
            <el-option
                v-for="(item,index) in goumaileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="购买类型" prop="goumaileixing">
	      <el-input v-model="ruleForm.goumaileixing"
                placeholder="购买类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shitijiage = true;
          ...
          if(o=='goumaileixing'){
            this.ruleForm.goumaileixing = obj[o];
	    this.ro.goumaileixing = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
      ...
      this.$http({
		...
		if(json.yonghushouji!=''&&json.yonghushouji){
          ...
          this.$message.error(data.msg);
            ...
            this.goumaileixingOptions = "电子版,线下提书".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({

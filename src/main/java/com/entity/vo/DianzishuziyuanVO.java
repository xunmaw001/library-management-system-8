 ...
 */
public class DianzishuziyuanVO  implements Serializable {
	...
	public void setDianzishu(String dianzishu) {
		this.dianzishu = dianzishu;
	}
	
	/**
	 * 获取：电子书
	 */
	public String getDianzishu() {
		return dianzishu;
	}
